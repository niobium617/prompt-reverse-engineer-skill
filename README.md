...
| 项目 | 说明 |
|------|------|
| [AI Prompt Hub](https://github.com/niobium617/ai-prompt-hub) | 集提示词库、AI 技能教程、在线工具、社区交流于一体的全栈学习项目（Vue 3 + NestJS + 微信小程序）。与本 Skill 理念同源——把好作品拆解为可复用的 Prompt；其提示词库与教程体系收录了本 Skill 的逆向分析方法论。 |
